...
public class RightTwoRotate : MonoBehaviour
{
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (otherTransform != null && other.CompareTag("RotateEnemy"))
        {
            //현재 회전에 추가로 180도 회전
            StartCoroutine(SmoothRotate(otherTransform, Quaternion.Euler(0, 180, 0), 1f));
        }
    }
