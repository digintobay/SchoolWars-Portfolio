...
public class Seyeong : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    public static bool seyeongSkill { get; set; } = false;
    ...
    public void Awake()
    {
        ...
        // 세영 어택 스피드 가져오기
        anim.SetFloat("AttackSpeed", SkillManager.seyeongAttackSpeed);
