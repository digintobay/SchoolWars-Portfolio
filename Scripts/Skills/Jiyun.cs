...
public class Jiyun : MonoBehaviour 
{
    public static bool jiyunSkill { get; set; } = false;
    ...
    public void OnLeftEffect()
    {
        LeftEffect.SetActive(true);
    }

    public void OnRightEffect()
    {
    ...
    public void Awake()
    {
        ...
        // 지윤 어택 스피드 가져오기
        anim.SetFloat("AttackSpeed", SkillManager.jiyunAttackSpeed);
